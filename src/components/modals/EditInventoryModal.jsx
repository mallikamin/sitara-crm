...
const EditInventoryModal = ({ open, onClose, onSave, inventoryItem }) => {
  ...
  useEffect(() => {
    if (inventoryItem) {
      setFormData({
        ...
        unitShopNumber: inventoryItem.unitShopNumber || inventoryItem.unit || '',
        unitType: inventoryItem.unitType || 'plot',
        marlas: inventoryItem.marlas || '',
        ratePerMarla: inventoryItem.ratePerMarla || '',
        plotFeatures: inventoryItem.plotFeatures || [],
        otherFeatures: inventoryItem.otherFeatures || '',
  ...
  const handleSubmit = (e) => {
    ...
    onSave(inventoryItem.id, updatedData);
    onClose();
  };
